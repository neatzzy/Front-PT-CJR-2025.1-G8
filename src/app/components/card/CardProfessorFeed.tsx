...
const CardProfessorFeed: React.FC<CardProps> = ({
  ...
  return (
    <div
      className="flex flex-col items-center justify-between gap-y-1 bg-white rounded-3xl shadow-1g p-3 w-fit min-h-fit h-60 cursor-pointer hover:shadow-2xl transition-shadow duration-300 border border-gray-250"
